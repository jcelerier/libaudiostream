...
class TThreadCmdManager : public TCmdManager
{
    ...
    private:
        ...
        ALIGN(16) boost::lockfree::stack<TCmd, boost::lockfree::capacity<MAXCOMMAND>> fFreeCmd;      // Commands free list
        ALIGN(16) boost::lockfree::queue<TCmd, boost::lockfree::capacity<MAXCOMMAND>> fRunningCmd ;   // Running commands
        bool fRunning;
