...
if(NO_LIBSNDFILE)
	...
	if(SNDFILE_FOUND)
		set(SNDFILE_LIBRARIES ${SNDFILE_LIBRARY} CACHE INTERNAL "sndfile libs" FORCE)
		if(OGG_LIBRARY)
		  set(SNDFILE_LIBRARIES ${OGG_LIBRARY} ${SNDFILE_LIBRARIES} CACHE INTERNAL "sndfile libs" FORCE)
		endif()
		if(VORBIS_LIBRARY)
		  set(SNDFILE_LIBRARIES ${VORBIS_LIBRARY} ${SNDFILE_LIBRARIES} CACHE INTERNAL "sndfile libs" FORCE)
		endif()
		if(VORBIS_ENCODE_LIBRARY)
		  set(SNDFILE_LIBRARIES ${VORBIS_ENCODE_LIBRARY} ${SNDFILE_LIBRARIES} CACHE INTERNAL "sndfile libs" FORCE)
		endif()
		if(FLAC_LIBRARY)
		  set(SNDFILE_LIBRARIES ${FLAC_LIBRARY} ${SNDFILE_LIBRARIES} CACHE INTERNAL "sndfile libs" FORCE)
		endif()
	else()
		set(SNDFILE_LIBRARIES)
	endif()
